...
public class MakeBuild : MonoBehaviour {
    private static readonly string[] SceneArray = {
        "Assets/DevTest/StartScene.unity"};
    ...
    static void Linux() {
        ...
        buildPlayerOptions.locationPathName = "Builds/Linux/i3DeveloperTest";
    ...
    static void Windows() {
        BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions();
        buildPlayerOptions.scenes = SceneArray;
        buildPlayerOptions.locationPathName = "Builds/Windows/i3DeveloperTest.exe";
